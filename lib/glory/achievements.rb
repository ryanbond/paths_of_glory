module Achievements
  ...
  def award_achievement(achievement, level = nil, ref = nil, category = nil, point_value = 1)
    achievement.create!(:achievable => self, :level => level, :ref => ref, :category => category, :point_value => point_value)
  end
